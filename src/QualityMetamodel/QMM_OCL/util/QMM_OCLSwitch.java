 ...
 * @generated
 */
public class QMM_OCLSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case QMM_OCLPackage.MODULE_ELEMENT: {
			...
			case QMM_OCLPackage.OCL_EXPRESSION: {
			...
			case QMM_OCLPackage.VARIABLE_EXP: {
			...
			case QMM_OCLPackage.PRIMITIVE_EXP: {
			...
			case QMM_OCLPackage.STRING_EXP: {
			...
			case QMM_OCLPackage.BOOLEAN_EXP: {
			...
			case QMM_OCLPackage.NUMERIC_EXP: {
			...
			case QMM_OCLPackage.INTEGER_EXP: {
			...
			case QMM_OCLPackage.COLLECTION_EXP: {
			...
			case QMM_OCLPackage.COLLECTION_PART: {
			...
			case QMM_OCLPackage.COLLECTION_RANGE: {
			...
			case QMM_OCLPackage.COLLECTION_ITEM: {
			...
			case QMM_OCLPackage.ORDERED_SET_EXP: {
			...
			case QMM_OCLPackage.SEQUENCE_EXP: {
			...
			case QMM_OCLPackage.TUPLE_PART: {
			...
			case QMM_OCLPackage.MAP_ELEMENT: {
			...
			case QMM_OCLPackage.ENUM_LITERAL_EXP: {
			...
			case QMM_OCLPackage.OCL_UNDEFINED_EXP: {
			...
			case QMM_OCLPackage.STATIC_PROPERTY_CALL_EXP: {
			...
			case QMM_OCLPackage.STATIC_PROPERTY_CALL: {
			...
			case QMM_OCLPackage.STATIC_NAVIGATION_OR_ATTRIBUTE_CALL: {
			...
			case QMM_OCLPackage.STATIC_OPERATION_CALL: {
			...
			case QMM_OCLPackage.PROPERTY_CALL_EXP: {
			...
			case QMM_OCLPackage.PROPERTY_CALL: {
			...
			case QMM_OCLPackage.NAVIGATION_OR_ATTRIBUTE_CALL: {
			...
			case QMM_OCLPackage.OPERATION_CALL: {
			...
			case QMM_OCLPackage.OPERATOR_CALL_EXP: {
			...
			case QMM_OCLPackage.NOT_OP_CALL_EXP: {
			...
			case QMM_OCLPackage.REL_OP_CALL_EXP: {
			...
			case QMM_OCLPackage.EQ_OP_CALL_EXP: {
			...
			case QMM_OCLPackage.ADD_OP_CALL_EXP: {
			...
			case QMM_OCLPackage.INT_OP_CALL_EXP: {
			...
			case QMM_OCLPackage.MUL_OP_CALL_EXP: {
			...
			case QMM_OCLPackage.LAMBDA_CALL_EXP: {
			...
			case QMM_OCLPackage.COLLECTION_OPERATION_CALL: {
			...
			case QMM_OCLPackage.ITERATE_EXP: {
			...
			case QMM_OCLPackage.ITERATOR_EXP: {
			...
			case QMM_OCLPackage.VARIABLE_DECLARATION: {
			...
			case QMM_OCLPackage.LOCAL_VARIABLE: {
			...
			case QMM_OCLPackage.COLLECTION_TYPE: {
			...
			case QMM_OCLPackage.OCL_MODEL_ELEMENT_EXP: {
			...
			case QMM_OCLPackage.STRING_TYPE: {
			...
			case QMM_OCLPackage.BOOLEAN_TYPE: {
			...
			case QMM_OCLPackage.NUMERIC_TYPE: {
			...
			case QMM_OCLPackage.INTEGER_TYPE: {
			...
			case QMM_OCLPackage.ORDERED_SET_TYPE: {
			...
			case QMM_OCLPackage.SEQUENCE_TYPE: {
			...
			case QMM_OCLPackage.OCL_ANY_TYPE: {
			...
			case QMM_OCLPackage.TUPLE_TYPE: {
			...
			case QMM_OCLPackage.TUPLE_TYPE_ATTRIBUTE: {
			...
			case QMM_OCLPackage.OCL_MODEL_ELEMENT: {
			...
			case QMM_OCLPackage.LAMBDA_TYPE: {
			...
			case QMM_OCLPackage.OCL_FEATURE_DEFINITION: {
			...
			case QMM_OCLPackage.OCL_CONTEXT_DEFINITION: {
			...
			case QMM_OCLPackage.OCL_FEATURE: {
			...
			case QMM_OCLPackage.OCL_METAMODEL: {
			...
			case QMM_OCLPackage.OCL_INSTANCE_MODEL: {
