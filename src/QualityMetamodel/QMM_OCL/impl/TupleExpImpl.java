 ...
 * </p>
 * <ul>
 *   <li>{@link QualityMetamodel.QMM_OCL.impl.TupleExpImpl#getTuplePart <em>Tuple Part</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleExpImpl extends OclExpressionImpl implements TupleExp {
	...
	protected EClass eStaticClass() {
		return QMM_OCLPackage.Literals.TUPLE_EXP;
	}
	...
	public EList<TuplePart> getTuplePart() {
		if (tuplePart == null) {
			tuplePart = new EObjectContainmentWithInverseEList<TuplePart>(TuplePart.class, this, QMM_OCLPackage.TUPLE_EXP__TUPLE_PART, QMM_OCLPackage.TUPLE_PART__TUPLE);
		}
		return tuplePart;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QMM_OCLPackage.TUPLE_EXP__TUPLE_PART:
