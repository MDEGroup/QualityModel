 ...
 * </p>
 * <ul>
 *   <li>{@link QualityMetamodel.QMM_OCL.impl.MapExpImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapExpImpl extends OclExpressionImpl implements MapExp {
	...
	protected EClass eStaticClass() {
		return QMM_OCLPackage.Literals.MAP_EXP;
	}
	...
	public EList<MapElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentWithInverseEList<MapElement>(MapElement.class, this, QMM_OCLPackage.MAP_EXP__ELEMENTS, QMM_OCLPackage.MAP_ELEMENT__MAP);
		}
		return elements;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QMM_OCLPackage.MAP_EXP__ELEMENTS:
