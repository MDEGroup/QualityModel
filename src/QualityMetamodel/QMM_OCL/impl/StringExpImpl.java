 ...
 * </p>
 * <ul>
 *   <li>{@link QualityMetamodel.QMM_OCL.impl.StringExpImpl#getStringSymbol <em>String Symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringExpImpl extends PrimitiveExpImpl implements StringExp {
	...
	protected EClass eStaticClass() {
		return QMM_OCLPackage.Literals.STRING_EXP;
	}
	...
	public void setStringSymbol(String newStringSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QMM_OCLPackage.STRING_EXP__STRING_SYMBOL, oldStringSymbol, stringSymbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QMM_OCLPackage.STRING_EXP__STRING_SYMBOL:
