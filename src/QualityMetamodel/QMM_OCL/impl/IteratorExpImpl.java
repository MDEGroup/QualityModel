 ...
 * </p>
 * <ul>
 *   <li>{@link QualityMetamodel.QMM_OCL.impl.IteratorExpImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IteratorExpImpl extends LoopExpImpl implements IteratorExp {
	...
	protected EClass eStaticClass() {
		return QMM_OCLPackage.Literals.ITERATOR_EXP;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QMM_OCLPackage.ITERATOR_EXP__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QMM_OCLPackage.ITERATOR_EXP__NAME:
				return getName();
		}
