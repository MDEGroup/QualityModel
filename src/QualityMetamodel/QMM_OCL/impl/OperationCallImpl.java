 ...
 * </p>
 * <ul>
 *   <li>{@link QualityMetamodel.QMM_OCL.impl.OperationCallImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link QualityMetamodel.QMM_OCL.impl.OperationCallImpl#getOperationName <em>Operation Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationCallImpl extends PropertyCallImpl implements OperationCall {
	...
	protected EClass eStaticClass() {
		return QMM_OCLPackage.Literals.OPERATION_CALL;
	}
	...
	public EList<OclExpression> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentWithInverseEList<OclExpression>(OclExpression.class, this, QMM_OCLPackage.OPERATION_CALL__ARGUMENTS, QMM_OCLPackage.OCL_EXPRESSION__PARENT_OPERATION);
		}
		return arguments;
	}
	...
	public void setOperationName(String newOperationName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QMM_OCLPackage.OPERATION_CALL__OPERATION_NAME, oldOperationName, operationName));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QMM_OCLPackage.OPERATION_CALL__ARGUMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QMM_OCLPackage.OPERATION_CALL__ARGUMENTS:
				return getArguments();
			case QMM_OCLPackage.OPERATION_CALL__OPERATION_NAME:
