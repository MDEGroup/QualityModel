 ...
 * </p>
 * <ul>
 *   <li>{@link QualityMetamodel.QMM_OCL.impl.EnumLiteralExpImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumLiteralExpImpl extends OclExpressionImpl implements EnumLiteralExp {
	...
	protected EClass eStaticClass() {
		return QMM_OCLPackage.Literals.ENUM_LITERAL_EXP;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QMM_OCLPackage.ENUM_LITERAL_EXP__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QMM_OCLPackage.ENUM_LITERAL_EXP__NAME:
				return getName();
		}
