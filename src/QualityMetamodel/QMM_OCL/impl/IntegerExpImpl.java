 ...
 * </p>
 * <ul>
 *   <li>{@link QualityMetamodel.QMM_OCL.impl.IntegerExpImpl#getIntegerSymbol <em>Integer Symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerExpImpl extends NumericExpImpl implements IntegerExp {
	...
	protected EClass eStaticClass() {
		return QMM_OCLPackage.Literals.INTEGER_EXP;
	}
	...
	public void setIntegerSymbol(int newIntegerSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QMM_OCLPackage.INTEGER_EXP__INTEGER_SYMBOL, oldIntegerSymbol, integerSymbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QMM_OCLPackage.INTEGER_EXP__INTEGER_SYMBOL:
