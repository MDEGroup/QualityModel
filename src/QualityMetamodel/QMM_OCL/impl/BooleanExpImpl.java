 ...
 * </p>
 * <ul>
 *   <li>{@link QualityMetamodel.QMM_OCL.impl.BooleanExpImpl#isBooleanSymbol <em>Boolean Symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanExpImpl extends PrimitiveExpImpl implements BooleanExp {
	...
	protected EClass eStaticClass() {
		return QMM_OCLPackage.Literals.BOOLEAN_EXP;
	}
	...
	public void setBooleanSymbol(boolean newBooleanSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QMM_OCLPackage.BOOLEAN_EXP__BOOLEAN_SYMBOL, oldBooleanSymbol, booleanSymbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QMM_OCLPackage.BOOLEAN_EXP__BOOLEAN_SYMBOL:
