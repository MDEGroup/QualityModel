 ...
 * </p>
 * <ul>
 *   <li>{@link QualityMetamodel.impl.BooleanValueTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanValueTypeImpl extends ValueTypeImpl implements BooleanValueType {
	...
	protected EClass eStaticClass() {
		return QualityMetamodelPackage.Literals.BOOLEAN_VALUE_TYPE;
	}
	...
	public void setValue(Boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QualityMetamodelPackage.BOOLEAN_VALUE_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QualityMetamodelPackage.BOOLEAN_VALUE_TYPE__VALUE:
				return getValue();
		}
