 ...
 * </p>
 * <ul>
 *   <li>{@link QualityMetamodel.impl.EnumerationItemImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumerationItemImpl extends MinimalEObjectImpl.Container implements EnumerationItem {
	...
	protected EClass eStaticClass() {
		return QualityMetamodelPackage.Literals.ENUMERATION_ITEM;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QualityMetamodelPackage.ENUMERATION_ITEM__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QualityMetamodelPackage.ENUMERATION_ITEM__NAME:
				return getName();
		}
